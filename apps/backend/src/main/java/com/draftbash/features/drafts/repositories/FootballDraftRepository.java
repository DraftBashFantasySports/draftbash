        ...
        final String SQL = """
            ...
            FROM (
                SELECT p.id, p.first_name, p.last_name, p.age, p.height, p.weight, p.injury_status,
                    ...
                    t.current_win_streak, t.bye_week, t.logo_url, sp.rush_attempts, sp.rush_yards, 
                    sp.rush_touchdowns, sp.targets, sp.receptions, sp.receiving_yards, 
                    sp.receiving_touchdowns, sp.pass_attempts, sp.pass_completions, sp.pass_yards, 
                    sp.pass_touchdowns, sp.interceptions, sp.fumbles_lost, 
                    sp.two_point_conversions, sp.standard_fantasy_points, sp.ppr_fantasy_points,
                    sp.half_ppr_fantasy_points, kp.field_goals_attempted, kp.field_goals_made,
                    kp.extra_points_attempted, kp.extra_points_made, 
